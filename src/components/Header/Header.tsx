    ...
    <header className={styles.header}>
      <div className={`container ${styles.headerContainer}`}>
        ...
        <nav className={styles.nav}>
          ...
          <a href="#products" className={styles.navLink}>Pacotes</a>
      ...
      {isMenuOpen && (
        <div className={styles.mobileMenu}>
          ...
          <a href="#products" className={styles.mobileNavLink} onClick={toggleMenu}>Pacotes</a>
          <a href="#how-it-works" className={styles.mobileNavLink} onClick={toggleMenu}>Como Funciona</a>
          <a href="#faq" className={styles.mobileNavLink} onClick={toggleMenu}>FAQ</a>
          <a 
            href="https://discord.gg/seu-servidor" 
